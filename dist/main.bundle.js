...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_another_product_service__ = __webpack_require__(166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__template_form_template_form_component__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__reactive_form_reactive_form_component__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__reactive_regist_reactive_regist_component__ = __webpack_require__(165);
...
var BindComponent = (function () {
    function BindComponent() {
        ...
        this.name = '';
        this.searchInput = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* FormControl */]();
...
var ReactiveFormComponent = (function () {
    function ReactiveFormComponent() {
        ...
        this.formModel = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* FormGroup */]({
            dateRange: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* FormGroup */]({
                from: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* FormControl */](),
                to: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* FormControl */]()
            }),
            emails: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["g" /* FormArray */]([
                new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* FormControl */]("a@a.com"),
                new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* FormControl */]("b@b.com")
            ])
        });
    }
    ...
    ReactiveFormComponent.prototype.addEmail = function () {
        ...
        emails.push(new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* FormControl */]());
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__validator_validators__ = __webpack_require__(168);
...
var ReactiveRegistComponent = (function () {
    function ReactiveRegistComponent(fb) {
        ...
        this.formModel = fb.group({
            username: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].minLength(6)]],
            mobile: ['', __WEBPACK_IMPORTED_MODULE_2__validator_validators__["a" /* mobileValidator */]],
            passwordsGroup: fb.group({
                password: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].minLength(6)]],
                pconfirm: ['']
            }, { validator: __WEBPACK_IMPORTED_MODULE_2__validator_validators__["b" /* equalValidator */] }),
            checked: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].requiredTrue]]
        });
    }
...
module.exports = "<form #myForm=\"ngForm\" (ngSubmit)=\"onSubmit(myForm.value)\" class=\"col-md-6\">\n  <h3 class=\"text-center\">SPA表单一：\n    <small>模板式表单</small>\n  </h3>\n  <p>指令：<code>NgForm,NgModel,NgModelGroup</code></p>\n  <div class=\"form-group\">\n    <label for=\"user\">用户名: </label>\n    <input id=\"user\" #username=\"ngModel\" ngModel name=\"username\" type=\"text\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"phone\">手机号: </label>\n    <input id=\"phone\" ngModel name=\"mobile\" type=\"number\" class=\"form-control\">\n  </div>\n  <div ngModelGroup=\"passwordsGroup\">\n    <div class=\"form-group\">\n      <label for=\"pwd\">密码: </label>\n      <input id=\"pwd\" ngModel name=\"password\" type=\"password\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"pconfirm\">确认密码: </label>\n      <input id=\"pconfirm\" ngModel name=\"pconfirm\" type=\"password\" class=\"form-control\">\n    </div>\n  </div>\n  <div class=\"checkbox\">\n    <label>\n      <input type=\"checkbox\" ngModel name=\"checks\"> 同意\n    </label>\n  </div>\n  <button type=\"submit\" class=\"btn btn-info\">注册</button>\n  <hr>\n  <p>表单数据(json)：<br>{{myForm.value|json}}</p>\n  <p>用户名：{{username.value}}</p>\n</form>\n\n"
